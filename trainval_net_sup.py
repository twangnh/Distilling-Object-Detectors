...
def parse_args():
    ...
    parser.add_argument('--save_dir', dest='save_dir',
                        help='directory to save models', default="./temp",
                        type=str)
    ...
    parser.add_argument('--tfi', dest='turn_off_imitation',
                        help='turn_off_imitation',
                        default=False, type=bool)
...
if __name__ == '__main__':
    ...
    if args.net == 'vgg11':
        fasterRCNN = vgg11(imdb.classes, pretrained=True, class_agnostic=args.class_agnostic, sup=True)
    elif args.net == 'vgg16':
        ...
        pdb.set_trace()
    # teacher
    fasterRCNN_sup_vgg16 = vgg16(imdb.classes, pretrained=False, class_agnostic=args.class_agnostic,
                                 sup=True)
    ...
    fasterRCNN_sup_vgg16.eval()

    for param in fasterRCNN_sup_vgg16.parameters():
        param.requires_grad = False

    for param in fasterRCNN_sup_vgg16.RCNN_base.parameters():
        param.requires_grad = False
    ...
    normal_init(fasterRCNN.stu_feature_adap[0], 0, 0.0001, True)
    ...
    for epoch in range(args.start_epoch, args.max_epochs + 1):
        ...
        for step in range(iters_per_epoch):
            ...
            if step % args.disp_interval == 0:
                ...
                print("[session %d][epoch %2d][iter %4d/%4d] loss: %.4f, loss_sup: %.4f, lr: %.2e" \

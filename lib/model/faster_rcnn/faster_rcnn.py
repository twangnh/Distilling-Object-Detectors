...
class _fasterRCNN(nn.Module):
    ...
    def forward(self, im_data, im_info, gt_boxes, num_boxes):
        ...
        rois, rpn_loss_cls, rpn_loss_bbox, mask_batch = self.RCNN_rpn(base_feat, im_info, gt_boxes, num_boxes)
...
#add for fix multi-gpu training
        ...
        if self.sup:
            return rois, cls_prob, bbox_pred, rpn_loss_cls, rpn_loss_bbox, \
                   RCNN_loss_cls, RCNN_loss_bbox, rois_label, base_feat, mask_batch
        else:
